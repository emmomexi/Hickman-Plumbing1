...
export const metadata: Metadata = {
  ...
  description: "Family-owned & operated in Scottsdale, AZ since 2004. High-quality plumbing repairs, water heaters, and remodels with patriotic values. Call (480) 945-6771.",
