    ...
    <>
      <section className="bg-yellow-400 py-10 md:py-12 px-4 md:px-6 border-y-4 border-black text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-black mb-6 uppercase italic tracking-tighter">
            Need Help Right Now?
          </h2>
          <a
            href="tel:4809456111"
            className="inline-block bg-black text-white px-8 md:px-12 py-5 md:py-6 rounded-md font-black text-2xl md:text-3xl shadow-xl hover:scale-105 transition-transform"
          >
