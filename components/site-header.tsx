    ...
    <>
      <div className="bg-[#1B2A41] text-white py-3 px-4 md:px-6 border-b-4 border-[#B22234]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          <span className="flex items-center gap-2 font-bold text-sm md:text-base text-white">
            <MapPin size={20} className="text-[#B22234]" /> Serving Valley-Wide Locations
          </span>
          <a
            href="tel:4809456111"
      ...
      <nav className="bg-white py-4 md:py-6 px-4 md:px-12 flex justify-between items-center border-b-2 border-gray-100 sticky top-0 z-50">
        <Link href="/" className="flex flex-col">
          <span className="text-2xl md:text-4xl font-serif font-black tracking-tighter text-[#1B2A41] leading-none uppercase">
            Hickman
          </span>
          <span className="text-[10px] md:text-sm font-bold tracking-[0.2em] md:tracking-[0.3em] text-[#B22234] uppercase">
            Plumbing Inc.
          </span>
        </Link>
        ...
        <div className="flex items-center gap-3 md:gap-6">
          <Link
            ...
            className={`hidden sm:inline font-black uppercase tracking-tight text-sm md:text-base transition-colors ${
              activePage === 'home' ? 'text-[#B22234]' : 'text-[#1B2A41] hover:text-[#B22234]'
            }`}
          >
            Home
          </Link>
          <Link
            href="/services"
            className={`hidden sm:inline font-black uppercase tracking-tight text-sm md:text-base transition-colors ${
              activePage === 'services' ? 'text-[#B22234]' : 'text-[#1B2A41] hover:text-[#B22234]'
            }`}
          >
            Services
          </Link>
